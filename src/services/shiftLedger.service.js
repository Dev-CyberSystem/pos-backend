...
// export async function getShiftLedger({
//   shiftId,
//   salesLimit = 1000,
//   cashLimit = 1000,
// }) {
...
//     sales.reduce((a, s) => a + Number(s.total || 0), 0),
//   );
...
//     openingCash: round2(openingCashReal), // si querés mantener "openingCash" como el que se usa en cálculo
...
// /src/services/shiftLedger.service.js
import Shift from "../models/Shift.js";
import Sale from "../models/Sale.js";
import CashMovement from "../models/cashMovement.model.js";
import { AppError } from "../utils/errors.js";
